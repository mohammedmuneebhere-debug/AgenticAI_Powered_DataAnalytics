...
SOURCES: list[DataSource] = [
    ...
    DataSource(id="google_search", name="Google Search", description="Google web results through SerpAPI", default_enabled=True, requires_key="SERPAPI_API_KEY"),
    DataSource(id="google_trends", name="Google Trends", description="Search interest over time through SerpAPI", default_enabled=True, requires_key="SERPAPI_API_KEY"),
