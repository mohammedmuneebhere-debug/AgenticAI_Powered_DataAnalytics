    ...
    <div className="lg:col-span-7 bg-surface border border-surface-border/60 rounded-2xl flex flex-col overflow-hidden shadow-sm">
      <div className="flex items-center justify-between px-4 py-3 bg-surface-high/60 border-b border-surface-border/50">
        <div className="flex items-center gap-2">
          <span className="material-symbols-outlined text-[18px] text-on-surface">offline_bolt</span>
              ...
              <div className="flex items-start gap-2.5 flex-1 min-w-0">
                <span
                  className={`font-mono text-xs font-bold mt-0.5 ${
                    isHigh ? "text-[var(--text-primary)]" : "text-outline"
                  }`}
                >
                  {driver.rank}
                </span>
                <div className="min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-0.5 font-mono text-[11px] text-on-surface-variant flex-wrap">
                    <span>
                      Source: <strong className="text-on-surface font-medium">{driver.source}</strong>
                    </span>
                    <span>•</span>
              ...
              <span
                className={`font-mono text-[9px] uppercase px-2 py-0.5 rounded-full font-bold shrink-0 ${
                  isHigh
                    ...
                    : "bg-surface-high text-on-surface-variant border border-surface-border"
                }`}
              >
                {driver.strength}
              </span>
